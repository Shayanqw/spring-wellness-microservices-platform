...
public class GoalService {
    ...
    @Value("${wellness.service.url:http://wellness-service:8083/api}")
    ...
    public List<Object> fallbackSuggestResources(String goalId, Exception e) {
        logger.warn("Circuit Breaker triggered! Fallback for goal: {}, error: {}", goalId, e.getMessage());
        return List.of(
                Map.of(
    ...
    public Goal markAsCompleted(String id, String username) {
        Goal goal = getGoalById(id);
